                  ...
                  <table id="mytable" class="table defaultDataTable table-hover text-nowrap">
                    <thead>
                      <tr>
                        ...
                        <th>Language</th>
                        <?php }if(in_array(11,$settingsCheckbox)){ ?>
                        <th>Status</th>
                        <?php } ?>
                        <th>Action</th>
                      </tr>
                      ...
                      <div class="modal-body">
                        ...
                        <div id="main2">
                          <table>
                            ...
                            <tr>
                              <td valign="top" style="width: 165px" ><input type="checkbox" <?php echo (in_array(11,$settingsCheckbox) ? 'checked="checked"' : ''); ?> name="settingsCheckbox[]" id="settingsCheckbox10" value="11" />
                              Status</td>
                            </tr>
                          </table>
                        </div>
