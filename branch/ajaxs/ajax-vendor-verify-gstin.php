                      ...
                      <div class="multisteps-form__panel shadow p-4 bg-white js-active" data-animation="scaleIn">
                        ...
                        <div class="multisteps-form__content">
                          <div class="row">
                            ...
                            <div class="col-md-6">
                              <div class="input-group">
                                <input type="text" name="vendor_pan" class="m-input" id="vendor_pan" value="<?php $vendorPan; ?>">
                            ...
                            <div class="col-md-6">
                              <div class="input-group">
                                <input type="text" name="vendor_name" class="m-input" id="vendor_name">
                            ...
                            <div class="col-md-6">
                              <div class="input-group">
                                <input type="text" name="vendor_email" class="m-input" id="vendor_email">
                                <label>Email*</label>
                              </div>
                            </div>
                            <div class="col-md-6">
                              <div class="input-group">
                                <input type="text" name="vendor_alt_email" class="m-input" id="vendor_alt_email">
                                <label>Alternate Email</label>
                              </div>
                            </div>
                            <div class="col-md-6">
                              <div class="input-group">
                                <input type="number" name="vendor_phone" class="m-input" id="vendor_phone">
                                <label>Phone*</label>
                              </div>
                            </div>
                            <div class="col-md-6">
                              <div class="input-group">
                                <input type="number" name="vendor_alt_phone" class="m-input" id="vendor_alt_phone">
                            ...
                            <div class="col-md-6">
                              <div class="input-group">
                                <input type="text" name="city" class="m-input" id="city" value="<?php echo $gstDetails['pradr']['addr']['city']; ?>">
                                <label>City</label>
                              </div>
                            </div>
                            <div class="col-md-6">
                      ...
                      <div class="multisteps-form__panel shadow p-4 rounded bg-white step2" data-animation="scaleIn">
                        ...
                        <div class="multisteps-form__content">
                          <div class="form-table" id="customFields">
                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                  <input type="text" name="vendor_business_legal_name[]" class="m-input" id="vendor_business_legal_name" value="<?php echo $gstDetails['lgnm']; ?>">
                                  <label>GST Legal Name</label>
                                </div>
                                <div class="input-group">
                                  <input type="text" name="vendor_business_constitution[]" class="m-input" id="vendor_business_constitution" value="">
                                  <label>Constitution of Business</label>
                                </div>
                                <div class="input-group">
                              ...
                              <div class="col-md-6">
                                ...
                                <div class="input-group">
                                  <input type="number" name="vendor_business_trade_name[]" class="m-input" id="vendor_business_trade_name" value="<?php echo $valaddress_addr['bnm']; ?>">
                                ...
                                <div class="input-group">
                                  <input type="text" name="vendor_business_status[]" class="m-input" id="vendor_business_status">
                                  <label>Status</label>
                                </div>
                              </div>
                            </div>
                      ...
                      <div class="multisteps-form__panel shadow p-4 rounded bg-white" data-animation="scaleIn">
                        ...
                        <div class="multisteps-form__content">
                          <div class="row">
                            ...
                            <div class="col-md-6">
                              <div class="input-group">
                                <input type="file" name="vendor_bank_cancelled_cheque" class="m-input" id="vendor_bank_cancelled_cheque" placeholder="Upload Cancelled Chaque">
                                <label></label>
                              </div>
                            </div>
                          </div>
