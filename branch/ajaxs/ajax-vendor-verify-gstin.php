...
?>
      ...
      <label>Label</label>
            ...
            <div class="material-textfield">
      <input placeholder=" " type="text" value="imranj">
      <label>Label</label>
    </div> -->
            <!-- ********************* -->
          </div>
                    ...
                    <div class="form-table" id="customFields">
                      ...
                      ?>
                          <div class="row">
                            ...
                            <div class="col-md-6">
                              <div class="material-textfield">
                                <input type="text" name="vendorOtherAddress[<?= $key ?>][vendor_business_legal_name]" id="vendor_business_legal_name" value="<?php echo $gstDetails['lgnm']; ?>">
                                <label>GST Legal Name</label>
                              </div>
                              <div class="material-textfield">
                                <input type="text" name="vendorOtherAddress[<?= $key ?>][vendor_business_constitution]" id="vendor_business_constitution" value="">
                                <label>Constitution of Business</label>
                              </div>
                            ...
                            <div class="col-md-6">
                              ...
                              <div class="input-group">
                                <input type="number" name="vendorOtherAddress[<?= $key ?>][vendor_business_trade_name]" class="m-input" id="vendor_business_trade_name" value="<?php echo $valaddress_addr['bnm']; ?>">
                ...
                <div class="multisteps-form__panel shadow p-4 rounded bg-white" data-animation="scaleIn">
                  ...
                  <div class="multisteps-form__content">
                    <div class="row">
                      <div class="col-md-6">
                        <div class="material-textfield">
                          <input type="number" name="opening_balance" id="vendor_opening_balance">
                      ...
                      <div class="col-md-6">
                        <div class="material-textfield">
                          <input type="text" name="credit_period" id="vendor_credit_period">
                      ...
                      <div class="col-md-6">
                        <div class="material-textfield">
                          <input type="text" name="vendor_bank_address" id="vendor_bank_address">
                          <label>Bank Address</label>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="material-textfield">
                          <input type="text" name="vendor_bank_account_no" id="account_number">
                ...
                <div class="multisteps-form__panel shadow p-4 rounded bg-white" data-animation="scaleIn">
                  ...
                  <div class="multisteps-form__content">
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="material-textfield">
                          <input type="text" name="vendor_authorised_person_name" id="adminName">
                          <label>Name of Person*</label>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="material-textfield">
                          <input type="text" name="vendor_authorised_person_designation" id="vendor_authorised_person_designation">
                          <label>Designation</label>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="material-textfield">
                          <input type="text" name="vendor_authorised_person_phone" id="adminPhone">
                          <label>Phone Number*</label>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="material-textfield">
                          <input type="number" name="vendor_authorised_alt_phone" id="vendor_authorised_person_phone">
                          <label>Alternative Phone </label>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="material-textfield">
                          <input type="text" name="vendor_authorised_person_email" id="adminEmail">
                          <label>Email*</label>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="material-textfield">
                          <input type="email" name="vendor_authorised_alt_email" id="vendor_authorised_person_email">
