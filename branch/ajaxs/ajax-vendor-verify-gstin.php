                  ...
                  <div class="multisteps-form__content">
                    <div class="form-table" id="customFields">
                      ...
                      ?>
                          <div class="row">
                            <?php if ($key == 0) { ?>
                              <a href="javascript:void(0);" class="addCF btn btn-primary btnstyle mb-4" value="5">Add</a>
                            <?php } else { ?>
                ...
                <div class="multisteps-form__panel shadow p-4 rounded bg-white" data-animation="scaleIn">
                  ...
                  <div class="multisteps-form__content">
                    <div class="row">
                      <div class="col-md-6">
                        <div class="material-textfield">
                          <input type="number" name="opening_balance" id="vendor_opening_balance" value="20000">
                      ...
                      <div class="col-md-6">
                        <div class="material-textfield">
                          <input type="text" name="credit_period" id="vendor_credit_period" value="226">
