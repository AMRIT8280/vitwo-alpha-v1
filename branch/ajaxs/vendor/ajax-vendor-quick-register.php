...
function quickRegVendor($INPUTS){
  ...
  $vendorResObj = queryInsert("INSERT INTO `".ERP_VENDOR_DETAILS."` SET `company_id`='".$loginCompanyId."',`company_branch_id`='".$loginBranchId."',`vendor_code`='".$vendorCode."', `vendor_name`='".$vendorName."',`vendor_pan`='".$vendorPan."', `vendor_gstin`='".$vendorGstin."', `vendor_status`='guest', `vendor_created_by`='".$loginAdminId."', `vendor_updated_by`='".$loginAdminId."'");
