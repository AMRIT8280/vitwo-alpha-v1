...
if (isset($_POST['add_branch_location'])) {
  ...
  $locationUpdate = "INSERT INTO `erp_branch_otherslocation` 
                        SET 
...
<?php
} else if (isset($_GET['branchLocation'])) { ?>
                        ...
                        <div class="col-md-6 mb-3">
                          <div class="input-group">
                            <select name="branchId" class="form-control" id="selectedBranch">
                              ...
                              $sql = "SELECT `branch_id`,`branch_code`,`branch_name` FROM `erp_branches` WHERE `branch_status`='active'";
                              $res = $dbCon->query($sql);
                              while ($row = $res->fetch_assoc()) {
                              ?>
                                <option <?php if ($row['branch_id'] == $getBranchId) {
                                          echo "selected";
                ...
                <div class="card-body fontSize">
                  <div class="tab-content" id="custom-tabs-three-tabContent">
                    <div class="tab-pane fade show active aiBranchDetails1" id="aiBranchDetails1" role="tabpanel" aria-labelledby="custom-tabs-three-home-tab">
                      <?php
                      // console($_SESSION);
                      $branchId = base64_decode($_GET['branchLocation']);
